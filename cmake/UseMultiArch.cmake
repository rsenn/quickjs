...
elseif(NOT DEFINED CMAKE_INSTALL_LIBDIR)
  set(CMAKE_INSTALL_LIBDIR lib CACHE PATH "Specify the output directory for libraries (default is lib)")
endif()

if(NOT CMAKE_INSTALL_LIBDIR OR "${CMAKE_INSTALL_LIBDIR}" STREQUAL "lib")
   message("ENV{VSCMD_ARG_TGT_ARCH}: $ENV{VSCMD_ARG_TGT_ARCH}")
  ...
  if(SYSTEM_NAME AND EXISTS "${CMAKE_INSTALL_PREFIX}/${CMAKE_INSTALL_LIBDIR}/${SYSTEM_NAME}")
    set(CMAKE_INSTALL_LIBDIR lib/${SYSTEM_NAME})
  endif(SYSTEM_NAME AND EXISTS "${CMAKE_INSTALL_PREFIX}/${CMAKE_INSTALL_LIBDIR}/${SYSTEM_NAME}")
