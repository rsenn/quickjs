...
function(CMAKE_TRY_COMPILER_FLAG lang flag result)
  ...
  message("COMMAND ${CMAKE_COMMAND} -E env LC_ALL=C LC_MESSAGES=C LANG=C ${CMAKE_${lang}_COMPILER} ${COMMAND_PATTERN}")
  execute_process(
  ...
  message("COMPILER_FLAG_OUTPUT ${COMPILER_FLAG_OUTPUT}")
  message("COMPILER_FLAG_ERROR ${COMPILER_FLAG_ERROR}")
  message("COMPILER_FLAG_RESULT ${COMPILER_FLAG_RESULT}")
