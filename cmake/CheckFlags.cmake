...
macro(ADD_NOWARN_FLAGS)
  ...
  # nowarn_flag(-Wno-deprecated-anon-enum-enum-conversion) nowarn_flag(-Wno-extern-c-compat)
  # nowarn_flag(-Wno-implicit-int-float-conversion)
  # nowarn_flag(-Wno-deprecated-enum-enum-conversion) endif("${CMAKE_CXX_COMPILER_ID}" MATCHES
  # ".*Clang.*")
...
macro(check_debug_gdb_flag)
  ...
  if(OPT_CXX_G_GDB)
    if(NOT "${CMAKE_CXX_FLAGS_DEBUG}" MATCHES "-ggdb")
      set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -ggdb" CACHE STRING
                                                                       "C++ compiler options" FORCE)
