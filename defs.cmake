...
# message("QUICKJS_SOURCES = ${QUICKJS_SOURCES}") dump(QUICKJS_SOURCES)
...
if(CMAKE_ARCH_LIBDIR)
  set(QUICKJS_LIBRARY_DIR ${CMAKE_ARCH_LIBDIR})
else(CMAKE_ARCH_LIBDIR)
...
endif(CMAKE_ARCH_LIBDIR)

# message("libdir = ${QUICKJS_LIBRARY_DIR}") message("bindir =
# ${QUICKJS_BINARY_DIR}") message("includedir = ${QUICKJS_INCLUDE_DIR}")
